using System;
using Xunit;
using CSharpPractical.Chapter25_GettersSettersProperties.SuperStringTheory;

namespace CSharpPractical.Tests.Chapter25_GettersSettersProperties.SuperStringTheory;
