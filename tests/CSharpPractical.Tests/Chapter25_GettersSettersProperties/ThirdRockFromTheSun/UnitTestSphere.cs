using System;
using Xunit;
using CSharpPractical.Chapter25_GettersSettersProperties.ThirdRockFromTheSun;

namespace CSharpPractical.Tests.Chapter25_GettersSettersProperties.ThirdRockFromTheSun;
