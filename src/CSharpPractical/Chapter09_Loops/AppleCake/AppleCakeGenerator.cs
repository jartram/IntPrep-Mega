 ...
 * ```
 ...
 VALIDATION COMMAND:
 dotnet test --filter FullyQualifiedName~CSharpPractical.Tests.Chapter09_Loops.AppleCake.UnitTestsAppleCakeGenerator
 =======================================================================================
*/
...
namespace CSharpPractical.Chapter09_Loops.AppleCake
{
    ...
    {
        public string AppleCake(int number)
        {
            if (number % 15 == 0) return "applecake";
            if (number % 3 == 0) return "apple";
            if (number % 5 == 0) return "cake";
            return "";
        }
