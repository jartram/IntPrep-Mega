/*
 =======================================================================================
 CHALLENGE: Hangman-refactored (50-introduction-to-wpf)
 CHAPTER: Chapter50_IntroductionToWpf
 ...
 * This challenge is a solo-challenge. While you can help someone by giving some pointers or explaining something, the repo's should not contain copy-pasted code from another student. This challenge is a big part of you grade for OOP1, so be sure to take this challenge serious.
 ...
 VALIDATION COMMAND:
 dotnet test --filter FullyQualifiedName~CSharpPractical.Tests.Chapter50_IntroductionToWpf
 =======================================================================================
*/

﻿using System;

namespace CSharpPractical.Chapter50_IntroductionToWpf.Hangman_refactored
{
    class Program
    {
